...
class company < party
    ...
    def company
        ...
        is_company = gets.strip.to_i
            if is_company == 1 #Start helping user define their company party
...
class government < party
    def government
        ...
        if is_government = 1 #Start helping user define which government
                ...
                if government_answer == 1
                    ...
                    states.each.with_index do { |type, index| puts "#{index + 1}. #{type}"}
                        ...
                        when 9
                            ...
                            when 9
                                puts "#{@help[:one]}" #THIS IS NOT THE RIGHT HELP FILE BUT IS PLACEHOLDER!!!!
                            end
                        end
            ...
            puts "Is it a government part or representing government?"
...
class single_party_procedure < party
